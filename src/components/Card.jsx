...
function Card() {
  ...
  return (
    <div className="lg:px-20  lg:mx-0 mx-4 lg:py-10">
      <div className="font-bold text-3xl border-b-4 inline-block border-pink-600 ">
        Start Browsing
      </div>
      <div className="lg:grid lg:grid-cols-4 lg:gap-5 lg:space-y-0 space-y-5 py-3">
        <div  className="h-52 w-58 shadow-2xl hover:shadow-black cursor-pointer   rounded-xl">
          <img
            ...
            alt=""
          />
          <div onClick={handleProduct} className="text-center font-bold py-2 text-lg">Dinning Room</div>
        </div>
        <div  className="h-52 w-58 shadow-2xl hover:shadow-black cursor-pointer  rounded-xl">
          <img
            className="h-40 w-full object-cover rounded-t-xl"
            ...
            alt=""
          />
          <div onClick={handleProduct} className="text-center font-bold py-2 text-lg">Living Room</div>
        </div>
        <div  className="h-52 w-58 shadow-2xl hover:shadow-black cursor-pointer  rounded-xl">
          <img
            className="h-40 w-full object-cover rounded-t-xl"
            ...
            alt=""
          />
          <div onClick={handleProduct} className="text-center font-bold py-2 text-lg">Office</div>
        </div>
        <div  className="h-52 w-58 shadow-2xl hover:shadow-black cursor-pointer  rounded-xl">
          <img
            className="h-40 w-full object-cover rounded-t-xl"
            ...
            alt=""
          />
          <div onClick={handleProduct} className="text-center font-bold py-2 text-lg">BedRoom</div>
        </div>
        <div  className="h-52 w-58 shadow-2xl hover:shadow-black cursor-pointer  rounded-xl">
          <img
            className="h-40 w-full object-cover rounded-t-xl"
            ...
            alt=""
          />
          <div onClick={handleProduct} className="text-center font-bold py-2 text-lg">Outdoor</div>
        </div>
        <div  className="h-52 w-58 shadow-2xl hover:shadow-black cursor-pointer  rounded-xl">
          <img
            className="h-40 w-full object-cover rounded-t-xl"
            ...
            alt=""
          />
          <div onClick={handleProduct} className="text-center font-bold py-2 text-lg">
            Entertainment
          </div>
        </div>
        <div  className="h-52 w-58 shadow-2xl hover:shadow-black cursor-pointer  rounded-xl">
          <img
            ...
            alt=""
          />
          <div onClick={handleProduct} className="text-center font-bold py-2 text-lg">Kids Bedroom</div>
        </div>
        <div  className="h-52 w-58 shadow-2xl hover:shadow-black cursor-pointer  rounded-xl">
          <img
            className="h-40 w-full object-cover rounded-t-xl"
            ...
            alt=""
          />
          <div onClick={handleProduct} className="text-center font-bold py-2 text-lg">Wall Art</div>
        </div>
      </div>
      <hr className="py-3" />
    </div>
